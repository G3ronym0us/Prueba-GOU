        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
              ...
              <ul class="navbar-nav ml-auto">
               ...
               <!-- <li class="nav-item dropdown">
                ...
                <li>
                  @auth
                        <a href="{{ url('/logout') }}" class="text-sm text-gray-700 underline">Cerrar Sesión</a>
                  @endauth
                </li>
              </ul>
            </nav>
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
              ...
              <a href="index3.html" class="brand-link">  
                <span class="brand-text font-weight-light">GOU</span>
              </a>
                ...
                <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <!-- Add icons to the links using the .nav-icon class
                         ...
                         <li class="nav-item">
                          <a href="{{ url('model_cars') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                        <li class="nav-item">
                          <a href="{{ url('balance_driver') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Balance de Conductores</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="{{ url('virtual_wallet') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                      <a href="{{ url('push_notification') }}" class="nav-link">
                        <i class="nav-icon fas fa-money-check-alt"></i>
                        <p>
                          Notificaciones Push
            ...
            <footer class="main-footer">
              <strong>Copyright &copy; 2020 <a href="https://adminlte.io">GOU</a>.</strong>
              All rights reserved.
